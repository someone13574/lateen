...
pub struct Theme {
    ...
    pub input_ring: Rgba,
    pub input_selection_bg: Rgba,
    pub input_placeholder_fg: Rgba,
...
impl Theme {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            input_border: rgb(0xcfcfca),
            input_focus_border: rgb(0x7ba3de),
            input_ring: rgb(0xb9cef0),
            input_selection_bg: rgb(0xb9cef0),
            input_placeholder_fg: rgb(0x95958c),
            ...
            heading_fg: rgb(0x4a4a44),
            body_fg: rgb(0x57574f),
            dim_fg: rgb(0x8b8b83),
            rule: rgb(0xe8e8e3),
            link_fg: rgb(0x22539c),
            chip_fg: rgb(0x4a4a44),
            chip_bg: rgb(0xeef3fb),
            chip_border: rgb(0x9dbbe6),
            danger_fg: rgb(0xa8412f),
            danger_bg: rgb(0xfaf0ee),
            danger_border: rgb(0xddc4c0),
            row_hover_bg: rgb(0xfbfcfe),
            pending_bg: rgb(0xf5f5f2),
            pending_border: rgb(0xdcdcd6),
            pending_meta_fg: rgb(0x83837c),
            import_action_fg: rgb(0x3d3d38),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            input_bg: rgb(0x26292d),
            input_border: rgb(0x3a3f45),
            input_focus_border: rgb(0x4a6fa5),
            input_ring: rgb(0x2c4a75),
            input_selection_bg: rgb(0x2c4a75),
            input_placeholder_fg: rgb(0x71777e),
            ...
            heading_fg: rgb(0xc6c9cd),
            body_fg: rgb(0xa9aeb4),
            dim_fg: rgb(0x7d838a),
            rule: rgb(0x2f3338),
            link_fg: rgb(0x8fb6ee),
            chip_fg: rgb(0xc6c9cd),
            chip_bg: rgb(0x22303f),
            chip_border: rgb(0x3f5f8c),
            danger_fg: rgb(0xe08272),
            danger_bg: rgb(0x33231f),
            danger_border: rgb(0x5a3a34),
            row_hover_bg: rgb(0x262b31),
            pending_bg: rgb(0x2b2f34),
            pending_border: rgb(0x3b4046),
            pending_meta_fg: rgb(0x8b9198),
            import_action_fg: rgb(0xd5d7da),
